! function (t) {
    ...
    window.addEventListener("DOMContentLoaded", (function () {
        ...
        o.style.position = "fixed", "left" == s.dataset.position ? o.style.left = parseInt(s.dataset.x_margin, 10) + 84 + "px" : o.style.right = parseInt(s.dataset.x_margin, 10) + 84 + "px", o.style.bottom = parseInt(s.dataset.y_margin, 10) - 2 + "px", o.style.transformOrigin = "right bottom", o.style.transform = "scale(0.7)", o.style.opacity = "0", o.style.transition = ".25s ease all", o.style.visibility = "hidden", o.style.background = "#ffffff", o.style.zIndex = "9999", o.innerText = s.dataset.message, o.style.boxShadow = "0px 2px 5px rgba(0, 0, 0, 0.05), 0px 8px 40px rgba(0, 0, 0, 0.04), 0px 0px 2px rgba(0, 0, 0, 0.15)", o.style.padding = "16px 16px", o.style.borderRadius = "4px", o.style.fontSize = "18px", o.style.color = "#0D0C22", o.style.width = "auto", o.style.maxWidth = "260px", o.style.lineHeight = "1.5", o.style.fontFamily = '"Avenir Book", sans-serif', setTimeout((function () {
        ...
        }), 5e3), document.body.appendChild(l), l.appendChild(a), document.body.appendChild(e), document.body.appendChild(o);
        let r = 0;
        e.onclick = function () {
